...
<article class="container">
	...
	<div class="col-md-12">
		...
		<div id="terms">
		<h3>이용약관 동의</h3>
    	<textarea id=termstext1 class="form-control col-sm-5" rows="10" style="resize: none;">
제1조(목적)
이 약관은 ㈜KOStyle(전자상거래 사업자)가 운영하는 인터넷 쇼핑몰(이하 “몰”이라 한다) 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 “몰”과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① “몰” 이란 (주)KOStyle가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
부 칙(개정) 이 약관은 2016년 11 월 9 일부터 시행합니다. 
    	...
    	<textarea id=termstext2 class="form-control col-sm-5" rows="10" style="resize: none;">
■ 수집하는 개인정보 항목
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="inputGender">성별</label>
					<div class="col-sm-6">
	  					<input type="radio" id="man" value="man" name="c_gender"> 남
	  					<input type="radio" id="woman" value="woman" name="c_gender" checked="checked"> 여
	  				</div>
			</div>
