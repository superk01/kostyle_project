                    ...
                    <div class="col-lg-8 col-lg-offset-2">
								...
								<fieldset>
									...
									<div hidden="hidden">
										<label>쇼핑몰</label>
										<span>
											<input type="text" name="statsSearchShop" id="statsSearchShop" value="${shoplogin.s_sname}">
										</span>
									</div>
									...
									<div id="statsSubmitbt">
										<a href="#" class="btn-header" id="statsSubmitShop">조회</a>
									</div>
								</fieldset>
								</form>
								</div>
...
//날짜 선택 옆에 radio클릭하면 날짜 선택에 입력
	...
	$("#statsSubmitShop").on("click", function(){
