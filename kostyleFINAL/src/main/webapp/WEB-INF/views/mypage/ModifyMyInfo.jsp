...
<%
	String birth = (String)request.getAttribute("c_birth");
	int p_powernum = (Integer)request.getAttribute("p_powernum");
 	String year = birth.substring(0,4);
	String month = birth.substring(4,6);
	String day = birth.substring(6,8);  
	String check = (String)request.getAttribute("c_sms");
	
%>

<form action="ModifySuccess.mypage" name="modifyform" onsubmit="return checkValue()">
<style type="text/css">
				...
				<div id="context_in">
					<div class="memberJoin">
							...
							<table class="dataAdd" summary="정보입력">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<label for="name">
												<input id="passText" class="passText1" name="c_pass" value="${c_pass}" onkeyup="checkByte(this, '20');" placeholder="비밀번호를 입력해주세요" type="text" onblur="pw_validation();"><br>
												<span id="m_pw"></span>
											</label>
											<span id="nameMsg" style="display: block; color:red"></span>
										</td>									
									...
									<tr>
										...
										<td>
											<input id="zip" name="c_zipcode" value="${c_zipcode}" onkeypress="onlyNum();" onBlur="zip_validation();" placeholder="우편번호" type="text" autocomplete="off"> &nbsp;<input type="button" value="우편번호"/>
											<span id="m_zip"></span>
											<br>
											<input id="ad" name="c_adress" value="${c_adress}"	onkeyup="checkByte(this, '20');" placeholder="주소를 입력하세요" type="text" size='60'>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<label for="email">
												<input id="emailText" class="inputTxt2" name="c_email" value="${c_email}" placeholder="이메일을 입력해 주세요" type="text">
											</label>
									...
									<th scope="row">
										...
										<td>
											<span id="mobileNoArea">${c_phonenumber}</span>
						...
						<div class="btn_mySite">
							...
							<input type="hidden" name="c_birth" value="${c_birth}">
							<input type="hidden" name="c_phonenumber" value="${c_phonenumber}">
							<input type="hidden" name="c_gender" value="${c_gender}">
							<input type="hidden" name="c_id" value="${c_id}">
							<input type="hidden" name="p_powernum" value="${p_powernum}">
